...
7. بالإضافة إلى التوصيات، قدم سيناريو واقعي قصير يوضح كيفية التعامل مع موقف مشابه

أجب بصيغة JSON فقط بالشكل التالي:
{
  "scenario": "وصف قصير لموقف مشابه قد يمر به ${isTeacher ? "معلم" : "طالب"} آخر يوضح طبيعة المشكلة",
  "recommendations": ["خطوة عملية 1", "خطوة عملية 2", ...],
  "suggested_category": "التصنيف المقترح",
  "detected_emotion": "المشاعر المكتشفة",
  "severity": "low|medium|high",
  "supportive_message": "رسالة دعم تشجيعية ${isTeacher ? "للمعلم" : "للطالب"} توضح أن المساعدة متاحة وأنه ليس وحده",
